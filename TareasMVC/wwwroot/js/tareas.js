function agregarNuevaTareaAlListado() {
    const nuevaTarea = new tareaElementoListadoViewModel({ id: 0, titulo: '' });

    tareaListadoViewModel.tareas.push(nuevaTarea);

    setTimeout(() => {
        const inputs = document.getElementsByName("titulo-tarea");
